...
<body>
	...
	<?php
		...
		<?php
				$affed = "SELECT Title from (SELECT PaperID from test.paper_reference where ReferenceID = '$paper_id') as temp inner join test.papers on papers.PaperID = temp.PaperID";
